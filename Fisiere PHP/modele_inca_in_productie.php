...
<head>
    <title>Modele care inca se produc</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="imagine-container">
            ...
            <div class="text-peste-imagine">MODELE CARE ÎNCĂ SE PRODUC</div>
        </div>
    ...
    <ul class="sub-meniu">
        ...
        <li><a class="active" href="modele_inca_in_productie.php">Modele în producție</a></li>
    ...
    $sql1 = "SELECT 
            ...
            WHERE im.an_sfarsit_prod IS NULL";
